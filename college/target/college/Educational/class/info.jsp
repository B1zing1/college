...
<div class="cztable">
	...
	<table border="1" width="100%" class="table_a">
               ...
               <tr>
                    ...
                    <td>
                        ${class1.department.departname}
                    </td>
                </tr>
                <tr>
                    <td>专业<span style="color:red">*</span>：</td>
                    <td>
                        ${class1.major.majorname}
                    </td>
                </tr>
                ...
                <tr>
				 ...
				 <tr>
                    ...
                    <td>
                        <fmt:formatDate value="${class1.classbegin}" pattern="yyyy-MM-dd hh:mm:ss"></fmt:formatDate>
                    </td>
                </tr>
                <tr>
                    <td>毕业时间：<span style="color:red">*</span>：</td>
                    <td>
                        <fmt:formatDate value="${class1.classend}" pattern="yyyy-MM-dd hh:mm:ss"></fmt:formatDate>
                    </td>
                </tr>
                <tr>
