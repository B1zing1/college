...
<div class="morebt">
 ...
 <div class="cztable">
     <form action="/qingjia/addLeaveBill" method="post">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tbody>
            <tr style="height: 25px" align="center">
                <th colspan="8">添加请假单</th>
            </tr>
               <input type="hidden" value="${userTb1.userId}" name="userTb.userId">
              <tr style="height: 25px" align="center">
                    <th scope="col">请假人:</th>
                    <th scope="col"><input type="text" value="${userTb1.userRealname}"readonly> </th>
                </tr>
            <tr style="height: 25px" align="center">
                <th scope="col">原因</th>
