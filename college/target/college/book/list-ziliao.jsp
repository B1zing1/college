    ...
    <script type="text/javascript">
        ...
        $(function () {
            $("[name=num]").change(function () {
                var size = $(this).val();
                location.href = "/book/findAllInfo?size=" + size;
            });
        })
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="text-align:center;">
                ...
                <c:forEach items="${pageInfo.list}" var="information">
                    <tr>
                        ...
                        <td>
                            <a href="/book/findInfoById?informationid=${information.informationid}">详情</a>
                            <a href="/book/findInfoToUpdate?informationid=${information.informationid}">编辑</a>
                        </td>
                    </tr>
                </c:forEach>
                <tr>
                    <td colspan="20" style="text-align: center;">
                        ...
                        <doPage:fy url="/book/findAllInfo?informationname=${informationname}&infotype=${infotype}" pageInfo="${pageInfo}"></doPage:fy>
                    </td>
                </tr>
            </table>
        </div>
